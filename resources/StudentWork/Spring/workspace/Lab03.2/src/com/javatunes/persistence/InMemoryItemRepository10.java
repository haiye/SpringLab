...
@Named
// TODO (In second part of lab) Add InMemory Qualifier 
public class InMemoryItemRepository10 implements ItemRepository {
	...
	public String toString() {
		return "InMemoryItemRepository Version 1.0";
	}
